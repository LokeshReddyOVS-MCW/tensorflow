...
absl::Status DotGeneralImpl(ConvolutionOp& op, const Tensor& lhs,
  ...
  absl::InlinedVector<DimensionSize, kMaxNumDimensions> lhs_index_helper(lhs_rank);
  absl::InlinedVector<DimensionSize, kMaxNumDimensions> rhs_index_helper(rhs_rank);
