...
class ConvolutionOp {
 public:
  ...
  std::vector<Axis> lhs_permutations;
  std::vector<std::byte> lhs_transposed_data;
  std::vector<Axis> rhs_permutations;
  std::vector<std::byte> rhs_transposed_data;
  std::vector<Axis> output_permutations;
  ...
  std::vector<Axis> lhs_contracting_dimensions;
  std::vector<Axis> rhs_contracting_dimensions;
